...
You can also set the Site Manifest display option to be "Browser" rather than
the generated value of "Standalone". Using Browser as the display option ensures
mobile devices add shortcuts rather than offering to install as an app.
